...
data: dict = {
    ...
    'Diversity on Cifar-fs': [
        '0.100 +- 2.18e-05',  # (1.540566711603081e-05)*(2**0.5)
        '0.103 +- 1.05e-5',  # (1.165581341940706e-05)**(2**0.5)
        '0.0847 +- 3.06e-5',  # (2.1658964828476216e-05)*(2**0.5)
        '0.0643 +- 9.64e-6'  # (6.821890007948446e-06)*(2**0.5)
    ],
}
