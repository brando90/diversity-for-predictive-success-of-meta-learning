...
import wandb
import numpy as np
run = wandb.init(project="Gradient Descent for Diversity of 1d Gaussian (Covariance)", entity="patrickyu")
...
def dv(N, M, mu_b, sigma_b):
    ...
    for i in range(N):
        ...
        div_coeff = covariance(X1,X2,M)#1 - pearsonr(X1, X2)
...
mu_0 = 50.0
sigma_0 = 50.0
steps = 50 #number of steps/"epochs"
